(() => {
    ...
    document.body.innerHTML = `
      <div class="mobile-404-screen">
        <div class="mobile-404-box">
          ...
          <div class="mobile-404-title">Мобильная версия пока в разработке</div>
          <div class="mobile-404-text">Сайт NameHunter сейчас оптимизирован под ПК. Для телефона пока доступен только переход в Telegram-бота, где уже работают основные функции сервиса.</div>
  ...
  const initRevealAnimations = () => {
    const items = Array.from(document.querySelectorAll('.fade'));
